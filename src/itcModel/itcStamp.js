const itcEvent = require('./itcEvent');
const itcId = require('./itcId');
...
function Instance(id, event) {
    ...
    this.fork = function fork() {
        ...
        var newStamp0 = new Instance(newIds[0], that.itcEvent.clone());
        var newStamp1 = new Instance(newIds[1], that.itcEvent.clone());
...
function deserialize(stampJson) {
    ...
    var result = new Instance(id, event);
    return result;
}
